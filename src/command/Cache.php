...
class Cache extends Make
{
    ...
    protected function buildClass(string $name)
    {
        ...
        $erpName = Env::get('app.erp_name', 'erp管理系统');
    ...
    {
        return app()->getRootPath() . 'extend' . DIRECTORY_SEPARATOR . 'erp' . DIRECTORY_SEPARATOR . 'command' . DIRECTORY_SEPARATOR . 'stubs' . DIRECTORY_SEPARATOR . 'cache.stub';
    }
